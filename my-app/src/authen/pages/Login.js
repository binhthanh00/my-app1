                         ...
                         <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="col-lg-4">
                                    <div class="login-content card">
                                        ...
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="User name" name="username" onChange={this.onDataChange}/>
                                            </div>
                                            <div class="form-group">
                                                <label>Password</label>
                                                 <input type="password" class="form-control" placeholder="Password" name="password" onChange={this.onDataChange}/>
                                            </div>
                                    <div class="checkbox">
                                        <label>
                                    ...
                                    <button type="button" class="btn btn-primary btn-flat m-b-30 m-t-30"  onClick={this.btnLogin}>Sign in</button>
